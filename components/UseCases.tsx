...
export default function UseCases() {
  return (
    <section id="use-cases" className="py-24 bg-gradient-to-b from-dark-light to-dark">
          ...
          {useCases.map((useCase, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-card rounded-xl p-8 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 border border-default backdrop-blur-sm hover:border-hover hover:-translate-y-1"
              >
