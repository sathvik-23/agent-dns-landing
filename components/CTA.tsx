          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0">
            ...
            <div className="relative group">
              <button
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 bg-card text-white/50 rounded-lg font-semibold text-base sm:text-lg backdrop-blur-sm border border-default cursor-not-allowed touch-manipulation opacity-60"
                disabled
              >
                Read Docs
              </button>
